package spp.bluetooth.jackwaiting.com.spptestdemo;
...
import spp.bluetooth.jackwaiting.com.spptestdemo.bluetooth.BluetoothDeviceManagerProxy;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bluetoothDeviceManagerProxy = BluetoothDeviceManagerProxy.getInstance(this);
        final BluetoothDeviceButtonRadioManager bluetoothDeviceButtonRadioManager = bluetoothDeviceManagerProxy.
                getBluetoothDeviceManager().getBluetoothDeviceButtonRadioManager();
        bluetoothDeviceButtonRadioManager.inquireCurrentVersion();
        bluetoothDeviceButtonRadioManager.openPA();
        bluetoothDeviceButtonRadioManager.setOnBluetoothDeviceGlobalUIChangedListener(new OnBluetoothDeviceButtonRadiolUIChangedListener() {
            @Override
            public void onBluetoothDeviceChannelPre() {
                LogManager.d("MainActivity","onBluetoothDeviceChannelPre");
            }

            @Override
            public void onBluetoothDeviceChannelNext() {
                bluetoothDeviceManagerProxy.getBluetoothDeviceManager().disconnectSpp();
                LogManager.d("MainActivity","onBluetoothDeviceChannelNext");
            }

            @Override
            public void onBluetoothDeviceStartRecord() {
                LogManager.d("MainActivity","onBluetoothDeviceStartRecord");
            }

            @Override
            public void onBluetoothDeviceStopRecord() {
                LogManager.d("MainActivity","onBluetoothDeviceStopRecord");

            }

            @Override
            public void onBluetoothDeviceMusicNext() {
                LogManager.d("MainActivity","onBluetoothDeviceMusicNext");
                bluetoothDeviceButtonRadioManager.setVolume(mVolume);
            }

            @Override
            public void onBluetoothDeviceMusicPre() {
                LogManager.d("MainActivity","onBluetoothDeviceMusicPre");
                bluetoothDeviceButtonRadioManager.inquireVolume();
            }

            @Override
            public void onBluetoothDeviceSeekToStart() {
                LogManager.d("MainActivity","onBluetoothDeviceSeekToStart");
            }

            @Override
            public void onBluetoothDeviceSeekToStop() {
                LogManager.d("MainActivity","onBluetoothDeviceSeekToStop");
            }

            @Override
            public void onBluetoothDeviceSeekBackStart() {
                LogManager.d("MainActivity","onBluetoothDeviceSeekBackStart");
            }

            @Override
            public void onBluetoothDeviceSeekBackStop() {
                LogManager.d("MainActivity","onBluetoothDeviceSeekBackStop");
            }

            @Override
            public void onBluetoothDeviceVolume(int volume) {
                LogManager.d("MainActivity","volume = " + volume);
                mVolume = volume;
            }

            @Override
            public void onBluetoothDeviceTipSuccess() {
                LogManager.d("MainActivity","onBluetoothDeviceTipSuccess");
            }
        });
        //bluetoothDeviceManagerProxy.getA2dpConnectState();
...
*/
    ...
    private BluetoothChatSppService mChatService = null;
    ...
    private void setupChat() {
        ...
        mChatService = BluetoothChatSppService.getInstance();
    ...
    public void onDestroy() {
        ...
        if (mChatService != null) mChatService.stopSpp();
    ...
    private void sendMessage(String message) {
        ...
        if (mChatService.getState() != ConnectionState.SPP_CONNECTED) {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MESSAGE_READ:
                    ...
                    LogManager.debug("Device sends command to App", "original command:",
                            readBuf);
